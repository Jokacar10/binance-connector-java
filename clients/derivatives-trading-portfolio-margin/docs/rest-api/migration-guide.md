# Migration Guide: Binance Derivatives Trading Portfolio Margin Connector Modularization
...
```java
import com.binance.connector.client.derivatives-trading-portfolio-margin.rest.api.DerivativesTradingPortfolioMarginRestApi;
```
